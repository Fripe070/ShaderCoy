    ...
    parser: parser.configure({
        props: [
            styleTags({
                ...
                'void bool int uint float vec2 vec3 vec4 ivec2 ivec3 ivec4 uvec2 uvec3 uvec4 bvec2 bvec3 bvec4 mat2 mat3 mat4 sampler2D sampler3D samplerCube': t.typeName
            })
        ]
    }),
    languageData: {
